...
def ingresoNombres (cantidad):#Esta función sirva para agregar los nombres de los jugadores a la lista Vacía de jugadores
    ...
    base_datos.guardar_jugadores(jugadores)
...
def anotacion (nroJugador,categoria,puntos):#Esto es para ingresar los puntos, hay que cambiar las opciones a un diccionario para validar si hay un error de tipeo.
    ...
    if categoria == 1:
        puntajeParcial[0] = puntos
    elif categoria == 2:
        puntajeParcial[1]= puntos
    elif categoria == 3:
        puntajeParcial[2]= puntos
    elif categoria == 4:
        puntajeParcial[3]= puntos
    elif categoria == 5:
        puntajeParcial[4]= puntos
    elif categoria == 6:
        puntajeParcial[5]= puntos
    elif categoria == 'E':
        puntajeParcial[6]= puntos
    elif categoria == 'F':
        puntajeParcial[7] = puntos
    elif categoria == 'P':
        puntajeParcial[8] = puntos
    elif categoria == 'G':
        puntajeParcial[9]= puntos
    elif categoria == 'GD':
        puntajeParcial[10] = puntos
